...
export const wsLatestVisibleFreshness = new Trend('ws_visible_latest_freshness_ms', true);
export const wsLatestVisibleSamples = new Counter('ws_visible_latest_samples_total');
export const wsLatestVisibleSloSamples = new Counter('ws_visible_latest_slo_samples_total');
export const wsVisibleGapMessages = new Trend('ws_visible_gap_messages', false);
...
export const wsInitialRoutePartitionId = new Trend('ws_initial_route_partition_id', false);
export const wsInitialRouteNodeTotal = new Counter('ws_initial_route_node_total');
export const wsReconnectRoutePartitionId = new Trend('ws_reconnect_route_partition_id', false);
export const wsReconnectRouteNodeTotal = new Counter('ws_reconnect_route_node_total');
