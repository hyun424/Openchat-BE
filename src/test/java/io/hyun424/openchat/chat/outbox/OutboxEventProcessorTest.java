...
class OutboxEventProcessorTest {
    ...
    @Test
    @DisplayName("PENDING 이벤트를 claim 후 room update, publish, hotchat 처리하고 PUBLISHED로 변경한다")
    void processBatch_success() {
        ...
        verify(roomService).updateLastMessage(1L, 1000L, "hello", "User");
    ...
    void processBatch_failureSchedulesRetry() {
        ...
        verify(hotChatService, never()).recordMessageActivity(anyLong(), anyString());
    }
